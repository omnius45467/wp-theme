...
echo '<li class="grid-item col-md-'.$layout_type['column'].' col-sm-6 post format-standard">'; ?>
	<div class="grid-item-inner">
		...
		<div class="grid-footer clearfix">
        	<?php if(!empty($instance['show_post_meta'])){ ?><?php if (comments_open()) { echo comments_popup_link('<i class="fa fa-comment"></i>'.__('No comments yet','framework'), '<i class="fa fa-comment"></i>1', '<i class="fa fa-comment"></i>%','pull-right meta-data', 'comments-link',__('Comments are off','framework')); } ?><?php } ?>
...
if (strpos($audio_url, 'soundcloud') > 0) {
	$data = imic_audio_soundcloud($audio_url,"100%",150);
}
else {
...
echo '<li class="grid-item col-md-'.$layout_type['column'].' col-sm-6 post format-standard">'; ?>
	<div class="grid-item-inner">
        <div class="post-media">
            <div class="fw-video"><?php echo $video_code; ?></div>
        </div>
		<div class="grid-content">
            <?php echo $title; ?>
            <?php if(!empty($instance['excerpt_length'])){ ?><?php echo $content; ?><?php } ?>
